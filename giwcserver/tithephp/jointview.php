         ...
         <header>
            ...
            <?php
                      $conn = mysqli_connect("127.0.0.1:3307", "root", "", "giwcdata");
                       ...
                       $jointno = $_GET['jointno'];
                       $sql = "SELECT * FROM joint WHERE jointno='$jointno' ORDER BY jointno ASC";
            ...
            <div class="project-container list">
                <div class="project">
                    ...
                    <h4><?php echo $row['jointname'];?></h4>
                   
                    </div>
                    <div class="status">
                    <h4><?php echo $row['jointno'];?></h4>
                    </div>
                    ...
                    <tr><td>OTHERS:</td><td><?php echo $row['jothers'];?></td></tr><br>
                    <i class="fas fa-calendar-alt"></i>
                    <tr><td>MONTH:</td><td><?php echo $row['jotmonth'];?></td></tr><br>
                    <i class="fas fa-dollar"></i>
                    <tr><td>AMOUNT:</td><td><?php echo $row['jotamount'];?></td></tr>
                    </h2>
