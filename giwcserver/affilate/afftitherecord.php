...
<head>
    ...
    <link rel="stylesheet" href="afftitherecord.css">
        ...
        <div class="container">
         <header>
             <h3>
               ...
               <img src="../svg/group-2-line.svg">
               Affiliate Tithe Records.
             </h3>
            ...
            <?php
                      $conn = mysqli_connect("127.0.0.1:3307", "root", "", "giwcdata");
                       ...
                       $sql = "SELECT * FROM afftithes WHERE titheno='$titheno' ORDER BY titheno ASC";
            ...
            <div class="project-container list">
                <div class="project">
                    ...
                    <div class="status">
                    <h4><?php echo $row['titheno'];?></h4>
                    </div>
                   
                   
                    <img class="profile-img" src="../svg/group-2-line.svg">
